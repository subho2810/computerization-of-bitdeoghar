 ...
 class dbmstake extends JFrame{
    ...
    public dbmstake(){
        ...
        checkresult.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    // String q="Select * from response where Student_name='"+n+"' and rollno='"+r+"' and Test_name='DBMS'";
                    ...
                    if(n.length()==0 || r.length()==0){
                        ...
                        String query="Select * from response where Student_name='"+n+"' and rollno='"+r+"' and Test_name='DBMS'";
                        ResultSet res=st.executeQuery(query);
                    if(res.next()==true){
                        String sc=res.getString("score");
                        String message="Score of "+n+" in DBMS is-> "+sc;
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    if(n.length()==0 || r.length()==0){
                        ...
                        String query="Select Student_name,rollno from response where Student_name='"+n+"' and rollno='"+r+"' and Test_name='DBMS'";
                    ResultSet res=st.executeQuery(query);
                    if(res.next()==true){
                        ...
                        String query2="Select * from examination where Test_name='DBMS'";
