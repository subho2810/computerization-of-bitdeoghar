...
class dbmsexam extends JFrame{
   ...
   static final String PASS = "";
    ...
    Statement st;
    static String rrn;
   public dbmsexam(String rr) {
       rrn=rr;
        setTitle("DATABASE MANAGESMENT SYSTEM TEST");
        setSize(1590,800);
        ...
        submit.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               try{
                String query2="Update response set score='"+Integer.toString(count)+"' where rollno='"+rr+"' and Test_name='DBMS'";
