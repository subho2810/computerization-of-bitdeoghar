...
import java.sql.*;
import java.awt.*;
class StudentLoginForm extends JFrame{
   ...
   static final String DB_URL = "jdbc:mysql://localhost:3306/computer_science_module?useSSL=false";
   static final String USER = "root";
   static final String PASS = "";
   Connection conn;
   Statement st;
	public StudentLoginForm(String x) {
        setTitle("LOGIN FORM");
        setSize(1590,800);
        ...
        signup.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                StudentRegister rg=new StudentRegister();
                setVisible(false);
                rg.setVisible(true);
		...
		login.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                      ...
                      String query="Select name,password,rollno from student where name='"+NAME+"' and password='"+PASSWORD+"'";
                      ResultSet res=st.executeQuery(query);
                      if(res.next()==true){
                        JOptionPane.showMessageDialog(null," ✌ Press OK To LOGIN ✌","Message",JOptionPane.INFORMATION_MESSAGE);
                        Studentdashboard oh=new Studentdashboard(NAME);
                        setVisible(false);
                        oh.setVisible(true);
                      }
                      else{
