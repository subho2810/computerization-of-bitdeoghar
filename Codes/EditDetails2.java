...
import java.awt.*;
 class EditDetails2 extends JFrame{
    public static Container h;
	public static JButton pswd,SUBJECT,Contact,EMAIL,goback;
    static final String DB_URL = "jdbc:mysql://localhost:3306/computer_science_module";
    static final String USER = "root";
    static final String PASS = "";
    Connection conn;
    Statement st;
    public EditDetails2(String N){
        setTitle("edit details page PAGE");
        setSize(1590,800);
        ...
        SUBJECT=new JButton("Edit SUBJECT");
        SUBJECT.setBounds(750,420,200,70);
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    if(pass.equals(PASSWORD)==true){
                      ...
                      String query2="Update faculty set password='"+PASSWORD1+"' where name='"+N+"'";
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    JOptionPane.showMessageDialog(frame, panel, "Edit Contact", JOptionPane.QUESTION_MESSAGE);
                     ResultSet res=st.executeQuery("Select * from faculty where contact='"+newContact.getText()+"'");
                     if(res.next()==true){
                        ...
                        String query2="Update faculty set contact='"+newContact.getText()+"' where name='"+N+"'";
                        st.executeUpdate(query2);
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    JOptionPane.showMessageDialog(frame, panel, "Edit EMAIL", JOptionPane.QUESTION_MESSAGE);
                     ResultSet res=st.executeQuery("Select * from faculty where email='"+newEMAIL.getText()+"'");
                     if(res.next()==true){
                        JOptionPane.showMessageDialog(null," ✌ Contact Already Registered ✌","Message",JOptionPane.INFORMATION_MESSAGE);
                     }
                        ...
                        String query2="Update faculty set email='"+newEMAIL.getText()+"' where name='"+N+"'";
                        st.executeUpdate(query2);
        ...
        SUBJECT.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    JPanel panel = new JPanel(new BorderLayout(5, 5));
                    JPanel label = new JPanel(new GridLayout(0, 1, 10, 2));
                    label.add(new JLabel("present new SUBJECT", SwingConstants.RIGHT));
                    panel.add(label, BorderLayout.WEST);
                    JPanel controls = new JPanel(new GridLayout(0, 1, 2, 2));
                    JTextField newSUBJECT = new JTextField();
                    controls.add(newSUBJECT);
                    panel.add(controls, BorderLayout.CENTER);
                    JOptionPane.showMessageDialog(frame, panel, "Edit SUBJECT", JOptionPane.QUESTION_MESSAGE);
                     ResultSet res=st.executeQuery("Select * from faculty where subject='"+newSUBJECT.getText()+"'");
                     if(res.next()==true){
                        JOptionPane.showMessageDialog(null," ✌ Contact Already Registered ✌","Message",JOptionPane.INFORMATION_MESSAGE);
                     }
                     else if(newSUBJECT.getText().length()==0){
                        JOptionPane.showMessageDialog(null," ✌ Fill the SUBJECT ✌","Message",JOptionPane.INFORMATION_MESSAGE);
                     }
                     else{
                        String query2="Update faculty set subject='"+newSUBJECT.getText()+"' where name='"+N+"'";
                        st.executeUpdate(query2);
                        JOptionPane.showMessageDialog(null," ✌ SUBJECT CHANGED ✌","Message",JOptionPane.INFORMATION_MESSAGE);
                     }
        ...
        goback.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                FacultyDetails obb=new FacultyDetails(N);
                setVisible(false);
                obb.setVisible(true);    
            }  
        });
