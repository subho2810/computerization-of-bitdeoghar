...
import java.sql.*;
import java.awt.*;
class FacultyDetails extends JFrame{
   ...
   static  String nn,rnn;
	public FacultyDetails(String NAME) {
        nn=NAME;
        
        setTitle("Faculty Detail Page");
        setSize(1590,800);
        ...
        try {
            conn = DriverManager.getConnection(DB_URL, USER, PASS);
             ...
             if(res.next()){
                 ...
                 Rno=res.getString("idno");
                 Address=res.getString("address");
                 Contact=res.getString("contact");
                 Gpa=res.getString("subject");
        ...
        label.setBounds(320,310, 500, 500);
        c.add(label);
		...
		gpa=new JLabel("SUBJECT -> "+Gpa);
		gpa.setBounds(230,400,350,40);
		gpa.setFont(font2);
        ...
        EditDetails.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                EditDetails2 obj=new EditDetails2(NAME);
                setVisible(false);
                obj.setVisible(true);
        ...
        goback.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                Facultydashboard mg=new Facultydashboard(nn);
                setVisible(false);
                mg.setVisible(true);
