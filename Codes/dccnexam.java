...
class dccnexam extends JFrame{
   ...
   static final String PASS = "";
    ...
    Statement st;
    static String rrn;
   public dccnexam(String rr) {
       rrn=rr;
        setTitle("Data Communication and Computer Networking TEST");
        setSize(1590,800);
        ...
        submit.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               try{
                String query2="Update response set score='"+Integer.toString(count)+"' where rollno='"+rr+"' and Test_name='DCCN'";
