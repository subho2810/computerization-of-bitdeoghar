...
class seexam extends JFrame{
   ...
   static final String PASS = "";
    ...
    Statement st;
    static String rrn;
   public seexam(String rr) {
       rrn=rr;
        setTitle("SOFTWARE ENGINEERING TEST");
        setSize(1590,800);
        ...
        submit.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               try{
                String query2="Update response set score='"+Integer.toString(count)+"' where rollno='"+rr+"' and Test_name='SE'";
